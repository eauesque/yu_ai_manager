"""Cross Search worker IPC -- JSON file-based inter-process communication."""
...
_PATHS = make_worker_ipc_paths("yu-cross-scan")
...
def get_worker_memory_rss(pid: int) -> int | None:
    return get_process_memory_rss(pid)
