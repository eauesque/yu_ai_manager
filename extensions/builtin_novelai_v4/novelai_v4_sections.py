...
def on_build_sections_impl(
    ...
    # rendered as sections here. They are not facts a reader wants as text; they
    # decide how the character-position overlay draws (grid vs free coordinates
    # vs order-only), and that renderer reads them straight off the payload.
    # Adding a section would show a bare "use_coords: null" with no context.
