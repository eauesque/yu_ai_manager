"""EXIF parsing helpers for WebP metadata extraction."""
...
def parse_exif_user_comment(exif_bytes: bytes) -> str | None:
    try:
        b = exif_bytes
        ...
        # UserComment payload endianness is independent of TIFF endianness:
        # yu_ai_manager bridge writes UTF-16-LE, NovelAI writes UTF-16-BE.
        # Delegate to the shared BOM + content-marker heuristic.
