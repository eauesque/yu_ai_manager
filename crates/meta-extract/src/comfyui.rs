...
/// Positive and negative CLIPTextEncode texts of a ComfyUI workflow.
///
/// Public because the detail view needs the *full* positive list to render
/// "All Positive Prompts"; the parser itself only keeps the first.
pub fn find_clip_texts(obj: &Value) -> (Vec<String>, Vec<String>) {
