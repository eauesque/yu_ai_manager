# Справочник API-эндпоинтов (автоматически сгенерирован)

> Этот файл автоматически генерируется `scripts/gen_api_docs.py`. Не редактируйте вручную.
> Источники: `routes/`, `extensions/`, `core/lan_share/`

**Всего**: 702 эндпоинтов

## Оглавление

- [Поиск](#поиск) (9 позиций)
- [Файлы](#файлы) (23 позиций)
- [Сканирование](#сканирование) (27 позиций)
- [Теги](#теги) (6 позиций)
- [Рейтинги и Избранное](#рейтинги-и-избранное) (9 позиций)
- [Коллекции](#коллекции) (9 позиций)
- [WD-Tagger](#wd-tagger) (35 позиций)
- [Анализ ИИ](#анализ-ии) (33 позиций)
- [Агенты](#агенты) (30 позиций)
- [LLM Router](#llm-router) (4 позиций)
- [Bridge](#bridge) (1 позиций)
- [Параметры](#параметры) (31 позиций)
- [Расширения](#расширения) (27 позиций)
- [Администрирование](#администрирование) (20 позиций)
- [SSE и логи](#sse-и-логи) (2 позиций)
- [Сетевой вывод](#сетевой-вывод) (4 позиций)
- [Hailo](#hailo) (19 позиций)
- [Общий доступ LAN](#общий-доступ-lan) (6 позиций)
- [Статистика](#статистика) (8 позиций)
- [Библиотека промптов](#библиотека-промптов) (12 позиций)
- [Чат](#чат) (19 позиций)
- [SNS и потоки](#sns-и-потоки) (55 позиций)
- [MCP и внутренний API](#mcp-и-внутренний-api) (313 позиций)
