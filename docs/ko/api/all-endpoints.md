...
> 이 파일은 `scripts/gen_api_docs.py`에 의해 자동 생성됩니다. 수동으로 편집하지 마십시오.
> 소스: `routes/`, `extensions/`, `core/lan_share/`
...
- [스캔](#스캔) (27 항목)
- [태그](#태그) (6 항목)
- [평점 및 즐겨찾기](#평점-및-즐겨찾기) (9 항목)
- [컬렉션](#컬렉션) (9 항목)
- [WD-Tagger](#wd-tagger) (35 항목)
- [AI 분석](#ai-분석) (33 항목)
- [에이전트](#에이전트) (30 항목)
- [LLM Router](#llm-router) (4 항목)
- [Bridge](#bridge) (1 항목)
- [설정](#설정) (31 항목)
- [확장 기능](#확장-기능) (27 항목)
- [관리](#관리) (20 항목)
- [SSE 및 로그](#sse-및-로그) (2 항목)
- [메시 추론](#메시-추론) (4 항목)
- [Hailo](#hailo) (19 항목)
- [LAN 공유](#lan-공유) (6 항목)
- [통계](#통계) (8 항목)
- [프롬프트 라이브러리](#프롬프트-라이브러리) (12 항목)
- [채팅](#채팅) (19 항목)
- [SNS 및 스트림](#sns-및-스트림) (55 항목)
- [MCP 및 내부 API](#mcp-및-내부-api) (313 항목)
