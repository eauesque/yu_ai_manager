# Referência de Endpoints da API (gerado automaticamente)

> Este arquivo é gerado automaticamente por `scripts/gen_api_docs.py`. Não edite manualmente.
> Fontes: `routes/`, `extensions/`, `core/lan_share/`

**Total**: 702 endpoints

## Sumário

- [Pesquisa](#pesquisa) (9 entradas)
- [Arquivos](#arquivos) (23 entradas)
- [Varredura](#varredura) (27 entradas)
- [Tags](#tags) (6 entradas)
- [Classificações e Favoritos](#classificações-e-favoritos) (9 entradas)
- [Coleções](#coleções) (9 entradas)
- [WD-Tagger](#wd-tagger) (35 entradas)
- [Análise de IA](#análise-de-ia) (33 entradas)
- [Agentes](#agentes) (30 entradas)
- [LLM Router](#llm-router) (4 entradas)
- [Bridge](#bridge) (1 entradas)
- [Configurações](#configurações) (31 entradas)
- [Extensões](#extensões) (27 entradas)
- [Administração](#administração) (20 entradas)
- [SSE e Logs](#sse-e-logs) (2 entradas)
- [Inferência em Mesh](#inferência-em-mesh) (4 entradas)
- [Hailo](#hailo) (19 entradas)
- [Compartilhamento LAN](#compartilhamento-lan) (6 entradas)
- [Estatísticas](#estatísticas) (8 entradas)
- [Biblioteca de Prompts](#biblioteca-de-prompts) (12 entradas)
- [Bate-papo](#bate-papo) (19 entradas)
- [SNS e Fluxos](#sns-e-fluxos) (55 entradas)
- [MCP e API Interna](#mcp-e-api-interna) (313 entradas)

## Pesquisa

| Método | Caminho | Descrição | Arquivo |
|---------|------|------|---------|
