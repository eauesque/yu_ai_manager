# Riferimento Endpoint API (generato automaticamente)

> Questo file è generato automaticamente da `scripts/gen_api_docs.py`. Non modificare manualmente.
> Fonti: `routes/`, `extensions/`, `core/lan_share/`

**Totale**: 702 endpoint

## Indice

- [Ricerca](#ricerca) (9 voci)
- [File](#file) (23 voci)
- [Scansione](#scansione) (27 voci)
- [Tag](#tag) (6 voci)
- [Valutazioni e Preferiti](#valutazioni-e-preferiti) (9 voci)
- [Collezioni](#collezioni) (9 voci)
- [WD-Tagger](#wd-tagger) (35 voci)
- [Analisi IA](#analisi-ia) (33 voci)
- [Agenti](#agenti) (30 voci)
- [LLM Router](#llm-router) (4 voci)
- [Bridge](#bridge) (1 voci)
- [Impostazioni](#impostazioni) (31 voci)
- [Estensioni](#estensioni) (27 voci)
- [Amministrazione](#amministrazione) (20 voci)
- [SSE & Log](#sse--log) (2 voci)
- [Inferenza Mesh](#inferenza-mesh) (4 voci)
- [Hailo](#hailo) (19 voci)
- [Condivisione LAN](#condivisione-lan) (6 voci)
- [Statistiche](#statistiche) (8 voci)
- [Libreria di Prompt](#libreria-di-prompt) (12 voci)
- [Chat](#chat) (19 voci)
- [SNS e Flussi](#sns-e-flussi) (55 voci)
- [MCP e API Interna](#mcp-e-api-interna) (313 voci)

## Ricerca

| Metodo | Percorso | Descrizione | File |
|---------|------|------|---------|
