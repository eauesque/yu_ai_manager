...
El servidor MCP (Model Context Protocol) de YU AI Manager proporciona una lista completa de todas las herramientas disponibles.
Puede invocar estas herramientas desde Claude Desktop u otros clientes MCP para automatizar la gestión, análisis y generación de bibliotecas.

**Total de herramientas: 521**
...
|------|------|-----------|
| `YU_BASE_URL` | URL del servidor YU AI Manager | `http://localhost:5000` |
| `YU_API_KEY` | API Key (autenticación Bearer) | (ninguno) |
| `YU_DEBUG_MODE` | `1` para habilitar herramientas de depuración | `0` |
...
Las herramientas `wait_for_scan` / `wait_for_batch` son compatibles con Notificaciones MCP:
- **Clientes compatibles con progressToken**: reciben progreso en tiempo real a través de `notifications/progress`
- **Clientes no compatibles**: esperan bloqueo y devuelven el resultado final al completarse

---

## Búsqueda y exploración (10)
...
## Registro de servidores etiquetadores (13)
...
## Observador de escaneo automático (3)
...
## Exploración de código fuente (3)
...
## Puerta de seguridad de agentes (25)
...
## Gestor de conjunto de datos LoRA (15)
...
## Funciones no compatibles con MCP
