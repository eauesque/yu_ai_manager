# Referencia de Endpoints API (generado automáticamente)

> Este archivo se genera automáticamente mediante `scripts/gen_api_docs.py`. No edite manualmente.
> Fuentes: `routes/`, `extensions/`, `core/lan_share/`

**Total**: 702 endpoints

## Tabla de Contenidos

- [Búsqueda](#búsqueda) (9 entradas)
- [Archivos](#archivos) (23 entradas)
- [Escanear](#escanear) (27 entradas)
- [Etiquetas](#etiquetas) (6 entradas)
- [Calificaciones y Favoritos](#calificaciones-y-favoritos) (9 entradas)
- [Colecciones](#colecciones) (9 entradas)
- [WD-Tagger](#wd-tagger) (35 entradas)
- [Análisis de IA](#análisis-de-ia) (33 entradas)
- [Agentes](#agentes) (30 entradas)
- [LLM Router](#llm-router) (4 entradas)
- [Bridge](#bridge) (1 entradas)
- [Configuración](#configuración) (31 entradas)
- [Extensiones](#extensiones) (27 entradas)
- [Administración](#administración) (20 entradas)
- [SSE y Registros](#sse-y-registros) (2 entradas)
- [Inferencia de Malla](#inferencia-de-malla) (4 entradas)
- [Hailo](#hailo) (19 entradas)
- [Compartición LAN](#compartición-lan) (6 entradas)
- [Estadísticas](#estadísticas) (8 entradas)
- [Biblioteca de Prompts](#biblioteca-de-prompts) (12 entradas)
- [Chat](#chat) (19 entradas)
- [SNS y Transmisiones](#sns-y-transmisiones) (55 entradas)
