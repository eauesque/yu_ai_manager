...
Utility APIs for duplicate detection, hash computation, similar image search, cache management, folder selection, DB backup, archive cleanup, and debug logging.
