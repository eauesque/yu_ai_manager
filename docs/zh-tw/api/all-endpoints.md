...
> 此檔案由 `scripts/gen_api_docs.py` 自動生成。請勿手動編輯。
> 來源：`routes/`, `extensions/`, `core/lan_share/`
...
- [評分與收藏](#評分與收藏) （9 項）
- [收藏集](#收藏集) （9 項）
- [WD-Tagger](#wd-tagger) （35 項）
- [AI分析](#ai分析) （33 項）
- [代理](#代理) （30 項）
- [LLM Router](#llm-router) （4 項）
- [Bridge](#bridge) （1 項）
- [設定](#設定) （31 項）
- [擴充功能](#擴充功能) （27 項）
- [管理](#管理) （20 項）
...
- [提示詞庫](#提示詞庫) （12 項）
- [聊天](#聊天) （19 項）
- [社交網路與串流](#社交網路與串流) （55 項）
- [MCP & 內部API](#mcp--內部api) （313 項）
