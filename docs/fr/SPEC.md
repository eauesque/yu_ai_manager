# Yu AI Manager — Spécification globale

> **Lecteurs cibles**: Claude Desktop などの AI エージェント  
> **Version**: v4.91.15  
...
7. [SSE イベント](#7-sse-イベント)
8. [DB スキーマ](#8-db-スキーマ)
9. [拡張（Extensions）](#9-拡張extensions)
...
## 5. Points de terminaison REST API
