# Référence des Endpoints API (généré automatiquement)

> Ce fichier est généré automatiquement par `scripts/gen_api_docs.py`. Ne pas éditer manuellement.
> Sources: `routes/`, `extensions/`, `core/lan_share/`

**Total**: 702 endpoints

## Table des Matières

- [Recherche](#recherche) (9 entrées)
- [Fichiers](#fichiers) (23 entrées)
- [Analyse](#analyse) (27 entrées)
- [Tags](#tags) (6 entrées)
- [Évaluations & Favoris](#évaluations--favoris) (9 entrées)
- [Collections](#collections) (9 entrées)
- [WD-Tagger](#wd-tagger) (35 entrées)
- [Analyse IA](#analyse-ia) (33 entrées)
- [Agents](#agents) (30 entrées)
- [LLM Router](#llm-router) (4 entrées)
- [Bridge](#bridge) (1 entrées)
- [Paramètres](#paramètres) (31 entrées)
- [Extensions](#extensions) (27 entrées)
- [Administration](#administration) (20 entrées)
- [SSE & Journaux](#sse--journaux) (2 entrées)
- [Inférence Mesh](#inférence-mesh) (4 entrées)
- [Hailo](#hailo) (19 entrées)
- [Partage LAN](#partage-lan) (6 entrées)
- [Statistiques](#statistiques) (8 entrées)
- [Bibliothèque de Prompts](#bibliothèque-de-prompts) (12 entrées)
- [Chat](#chat) (19 entrées)
- [SNS & Flux](#sns--flux) (55 entrées)
- [MCP et API Interne](#mcp-et-api-interne) (313 entrées)
