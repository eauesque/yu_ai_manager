# API-Endpunkt-Referenz (automatisch generiert)

> Diese Datei wird automatisch von `scripts/gen_api_docs.py` generiert. Nicht manuell bearbeiten.
> Quellen: `routes/`, `extensions/`, `core/lan_share/`

**Gesamt**: 702 Endpunkte

## Inhaltsverzeichnis

- [Suche](#suche) (9 Einträge)
- [Dateien](#dateien) (23 Einträge)
- [Scan](#scan) (27 Einträge)
- [Tags](#tags) (6 Einträge)
- [Bewertungen & Favoriten](#bewertungen--favoriten) (9 Einträge)
- [Sammlungen](#sammlungen) (9 Einträge)
- [WD-Tagger](#wd-tagger) (35 Einträge)
- [KI-Analyse](#ki-analyse) (33 Einträge)
- [Agenten](#agenten) (30 Einträge)
- [LLM Router](#llm-router) (4 Einträge)
- [Bridge](#bridge) (1 Einträge)
- [Einstellungen](#einstellungen) (31 Einträge)
- [Erweiterungen](#erweiterungen) (27 Einträge)
- [Verwaltung](#verwaltung) (20 Einträge)
- [SSE & Protokolle](#sse--protokolle) (2 Einträge)
- [Mesh-Inferenz](#mesh-inferenz) (4 Einträge)
- [Hailo](#hailo) (19 Einträge)
- [LAN-Freigabe](#lan-freigabe) (6 Einträge)
- [Statistiken](#statistiken) (8 Einträge)
- [Prompt-Bibliothek](#prompt-bibliothek) (12 Einträge)
- [Chat](#chat) (19 Einträge)
- [SNS & Streams](#sns--streams) (55 Einträge)
- [MCP & Interne API](#mcp--interne-api) (313 Einträge)

## Suche

| Methode | Pfad | Beschreibung | Datei |
|---------|------|------|---------|
